...
class ChessModel {
    ...
    fun reset(){
        ...
        piecesBox.add(
            ChessPiece(1,0,
                ChessPlayer.WHITE, ChessRank.KNIGHT, R.drawable.ic_white_knight
            )
        )
        piecesBox.add(
            ChessPiece(6,0,
        ...
        piecesBox.add(
            ChessPiece(1,7,
                ChessPlayer.BLACK, ChessRank.KNIGHT, R.drawable.ic_black_knight
            )
        )
        piecesBox.add(
            ChessPiece(6,7,
        ...
        piecesBox.add(
            ChessPiece(2,0,
                ChessPlayer.WHITE, ChessRank.BISHOP, R.drawable.ic_white_bishop
            )
        )
        piecesBox.add(
            ChessPiece(5,0,
        ...
        piecesBox.add(
            ChessPiece(2,7,
                ChessPlayer.BLACK, ChessRank.BISHOP, R.drawable.ic_black_bishop
            )
        )
        piecesBox.add(
            ChessPiece(5,7,
        ...
        piecesBox.add(
            ChessPiece(3,0,
                ChessPlayer.WHITE, ChessRank.QUEEN, R.drawable.ic_white_queen
            )
        )
        ...
        piecesBox.add(
            ChessPiece(3,7,
                ChessPlayer.BLACK, ChessRank.QUEEN, R.drawable.ic_black_queen
            )
        )
        ...
        for( i in 0..7){ //Pawns
            piecesBox.add(
                ChessPiece(i,1,
                    ChessPlayer.WHITE, ChessRank.PAWN, R.drawable.ic_white_pawn
                )
            )
            piecesBox.add(
                ChessPiece(i,6,
                    ChessPlayer.BLACK, ChessRank.PAWN, R.drawable.ic_black_pawn
                )
            )
        }
